            ...
            <div class="carousel-inner">
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           ...
                           <div class="read_bt"><a href="Product Details.html">Buy Now</a></div>
                        </div>
                        <div class="col-sm-6">
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           <h1 class="banner_taital">Promption Product <br>Item</h1>
                           <p class="banner_text">Description</p>
                           <div class="read_bt"><a href="Product Details.html">Buy Now</a></div>
                        </div>
                        <div class="col-sm-6">
                           <div class="banner_img"><img src="images/banner-img.png"></div>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <div class="row">
                        <div class="col-sm-6">
                           <h1 class="banner_taital">Beauty <br>Kit</h1>
                           <p class="banner_text">Promotion Product Description</p>
                           <div class="read_bt"><a href="Product Details.html">Buy Now</a></div>
                        </div>
                        <div class="col-sm-6">
                           <div class="banner_img"><img src="images/banner-img.png"></div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  ...
                  <p class="product_text">General Description</p>
               </div>
            </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="about_taital_main">
                        <h1 class="about_taital">About the Store</h1>
                        <p class="about_text">About the Store description</p>
